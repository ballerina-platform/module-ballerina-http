...
import org.ballerinalang.net.transport.contractimpl.Http2OutboundRespListener;
import org.ballerinalang.net.transport.contractimpl.common.Util;
import org.ballerinalang.net.transport.contractimpl.listener.http2.Http2SourceHandler;
import org.ballerinalang.net.transport.contractimpl.listener.http2.InboundMessageHolder;
import org.ballerinalang.net.transport.contractimpl.listener.states.http2.Response100ContinueSent;
import org.ballerinalang.net.transport.contractimpl.listener.states.http2.SendingHeaders;
import org.ballerinalang.net.transport.contractimpl.sender.http2.Http2ClientChannel;
import org.ballerinalang.net.transport.contractimpl.sender.http2.Http2DataEventListener;
import org.ballerinalang.net.transport.contractimpl.sender.http2.Http2TargetHandler;
import org.ballerinalang.net.transport.contractimpl.sender.http2.OutboundMsgHolder;
import org.ballerinalang.net.transport.contractimpl.sender.states.http2.RequestCompleted;
...
import static org.ballerinalang.net.transport.contract.Constants.BASE_64_ENCODED_CERT;
import static org.ballerinalang.net.transport.contract.Constants.CHNL_HNDLR_CTX;
import static org.ballerinalang.net.transport.contract.Constants.HTTP_SCHEME;
...
import static org.ballerinalang.net.transport.contract.Constants.IDLE_TIMEOUT_TRIGGERED_WHILE_READING_INBOUND_REQUEST_HEADERS;
import static org.ballerinalang.net.transport.contract.Constants.INBOUND_REQUEST;
import static org.ballerinalang.net.transport.contract.Constants.LISTENER_INTERFACE_ID;
import static org.ballerinalang.net.transport.contract.Constants.LISTENER_PORT;
import static org.ballerinalang.net.transport.contract.Constants.LOCAL_ADDRESS;
import static org.ballerinalang.net.transport.contract.Constants.MUTUAL_SSL_HANDSHAKE_RESULT;
import static org.ballerinalang.net.transport.contract.Constants.POOLED_BYTE_BUFFER_FACTORY;
...
import static org.ballerinalang.net.transport.contractimpl.common.states.StateUtil.handleIncompleteInboundMessage;
...
public class Http2StateUtil {
    ...
    /**
     * Sends {@link org.ballerinalang.net.transport.message.Http2Reset} frame with `NO_ERROR` error code.
     *
     * @param ctx      the channel handler context
     * @param encoder  the HTTP2 connection encoder
