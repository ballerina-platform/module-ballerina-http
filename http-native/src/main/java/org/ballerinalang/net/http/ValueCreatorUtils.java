...
public class ValueCreatorUtils {
    ...
    public static BObject createRequestObject() {
        return createObjectValue(ModuleUtils.getModule(), REQUEST);
    }

    public static BObject createResponseObject() {
        return createObjectValue(ModuleUtils.getModule(), RESPONSE);
    }
    ...
    public static BObject createPushPromiseObject() {
        return createObjectValue(ModuleUtils.getModule(), PUSH_PROMISE, StringUtils.fromString("/"),
                                 StringUtils.fromString("GET"));
    }

    public static BObject createRequestCacheControlObject() {
        return createObjectValue(ModuleUtils.getModule(), REQUEST_CACHE_CONTROL);
    }

    public static BObject createResponseCacheControlObject() {
        return createObjectValue(ModuleUtils.getModule(), RESPONSE_CACHE_CONTROL);
    }

    public static BObject createCallerObject() {
        return createObjectValue(ModuleUtils.getModule(), CALLER);
    }
    ...
    public static BMap<BString, Object> createHTTPRecordValue(String recordTypeName) {
        return ValueCreator.createRecordValue(ModuleUtils.getModule(), recordTypeName);
    }
