...
/**
 * {@code {@link Return }} handles the returned objects from resource to be sent out to the caller
 *
 * @since slp8
 */
public class Return extends ConnectionAction {

    private static final Logger log = LoggerFactory.getLogger(Return.class);

//    public static Object send(HttpCarbonMessage inboundRequestMsg, Object result) {
//
