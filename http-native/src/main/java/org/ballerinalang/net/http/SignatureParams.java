...
public class SignatureParams {
    ...
    private Map<BString, Integer> pathParamOrder = new HashMap<>();
    private Map<BString, Integer> queryParamOrder = new HashMap<>();
    private BString bodyParamName = null;
    ...
    SignatureParams(List<BType> paramTypes, AttachedFunction resource) {
        ...
        for (BString paramName : paramAnnotationKeys) {
            ...
            paramName = paramName.substring(PARAM.length() + 1, paramName.length());
            switch (paramType) {
     ...
     */
    BMap<BString, Object> getQueryParams(Object rawQueryString) {
        BMapType mapType = new BMapType(new BArrayType(BTypes.typeString));
        BMap<BString, Object> queryParams = new MapValueImpl<>(mapType);
     ...
     */
    Map<BString, Integer> getPathParamOrder() {
     ...
     * @return a map of param details
     */
    Map<BString, Integer> getQueryParamOrder() {
