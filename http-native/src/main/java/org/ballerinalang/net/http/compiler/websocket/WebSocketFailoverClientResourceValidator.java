 ...
 * @since 1.2.0
 */
class WebSocketFailoverClientResourceValidator extends WebSocketClientResourceValidator {

    WebSocketFailoverClientResourceValidator(DiagnosticLog dlog, BLangFunction resource) {
        super(dlog, resource);
    }
