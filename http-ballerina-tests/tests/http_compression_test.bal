...
listener http:Listener compressionAnnotListenerEP = checkpanic new(compressionAnnotationTestPort);
http:Client compressionAnnotClient = checkpanic new("http://localhost:" + compressionAnnotationTestPort.toString());
