...
listener http:Listener httpOptionsListenerEP = checkpanic new(httpOptionsTestPort);
http:Client httpOptionsClient = checkpanic new("http://localhost:" + httpOptionsTestPort.toString());
