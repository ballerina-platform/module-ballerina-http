...
listener http:Listener serviceEndpointTestEP = checkpanic new(serviceEndpointTest);
http:Client serviceEndpointClient = checkpanic new("http://localhost:" + serviceEndpointTest.toString());
