...
function testListenerOAuth2HandlerAuthSuccess() {
    http:OAuth2IntrospectionConfig config = {
        url: "https://localhost:" + oauth2AuthorizationServer + "/oauth2/token/introspect/success",
...
function testListenerOAuth2HandlerAuthnFailure() {
    http:OAuth2IntrospectionConfig config = {
        url: "https://localhost:" + oauth2AuthorizationServer + "/oauth2/token/introspect/failure",
        tokenTypeHint: "access_token",
        scopeKey: "scp",
        clientConfig: {
            secureSocket: {
