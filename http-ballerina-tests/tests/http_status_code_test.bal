...
listener http:Listener httpStatusCodeListenerEP = checkpanic new(httpStatusCodeTestPort);
http:Client httpStatusCodeClient = checkpanic new("http://localhost:" + httpStatusCodeTestPort.toString());
