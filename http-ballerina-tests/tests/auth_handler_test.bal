...
isolated function testListenerJwtAuthHandler() {
    ...
    if (authn1 is jwt:Payload) {
        ...
        test:assertEquals(authn1[scopeKey], "write");
    ...
    if (authn2 is jwt:Payload) {
        ...
        test:assertEquals(authn2[scopeKey], "write");
...
isolated function testListenerOAuth2Handler() {
    ...
    http:OAuth2IntrospectionConfig config = {
        url: "https://localhost:20000/oauth2/token/introspect",
