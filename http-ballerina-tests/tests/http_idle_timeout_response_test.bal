...
listener http:Listener idleTimeoutListenerEP = checkpanic new(idleTimeoutTestPort, { timeoutInMillis: 1000, server: "Mysql" });
http:Client idleTimeoutClient = checkpanic new("http://localhost:" + idleTimeoutTestPort.toString());
