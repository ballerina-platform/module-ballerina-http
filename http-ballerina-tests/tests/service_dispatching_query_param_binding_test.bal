...
listener http:Listener QueryBindingEP = checkpanic new(queryParamBindingTest);
http:Client queryBindingClient = checkpanic new("http://localhost:" + queryParamBindingTest.toString());
