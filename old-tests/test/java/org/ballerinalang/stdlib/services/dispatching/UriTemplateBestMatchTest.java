...
//     //     Assert.assertEquals(((BMap<BString, Object>) bJson).get(StringUtils.fromString("echo1")).toString(),
...
//     //     Assert.assertEquals(((BMap<BString, Object>) bJson).get(StringUtils.fromString("echo2")).toString(),
...
//     //     Assert.assertEquals(((BMap<BString, Object>) bJson).get(StringUtils.fromString("echo3")).toString(),
...
//     //     Assert.assertEquals(((BMap<BString, Object>) bJson).get(StringUtils.fromString("echo5")).toString(),
//     //                         "echo5"
...
//     //     Assert.assertEquals(((BMap<BString, Object>) bJson).get(StringUtils.fromString("first")).toString(),
//     //                         "shafreen anfar", "Resource dispatched to wrong template");

//     //     Assert.assertEquals(((BMap<BString, Object>) bJson).get(StringUtils.fromString("echo4")).toString(),
...
//     // @Test(description = "Test rest uri post fix. /echo69/a/b/c")
//     // public void testRestUriPostFix() {
//     //     HTTPTestRequest cMsg = MessageUtils.generateHTTPMessage("/echo69/a/b/c", "GET");
//     //     HttpCarbonMessage response = Services.invoke(TEST_EP_PORT, cMsg);
...
//     //     cMsg = MessageUtils.generateHTTPMessage("/echo69/a/c", "GET");
//     //     response = Services.invoke(TEST_EP_PORT, cMsg);
...
//     //     cMsg = MessageUtils.generateHTTPMessage("/echo69/a", "GET");
//     //     response = Services.invoke(TEST_EP_PORT, cMsg);
