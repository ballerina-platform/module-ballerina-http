...
import static io.ballerina.stdlib.http.transport.contractimpl.common.certificatevalidation.Constants.BOUNCY_CASTLE_PROVIDER;
...
class Utils {
    ...
    private static SenderConfiguration getSenderConfigs(String type) {
        ...
        Parameter paramClientCiphers = new Parameter("ciphers", "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256");
    ...
    private static ListenerConfiguration setListenerConfiguration(String keyStore, String keyStorePassword,
        ...
        Parameter paramServerCiphers = new Parameter("ciphers", "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256");
