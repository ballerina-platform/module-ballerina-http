...
import io.ballerina.stdlib.http.transport.contentaware.listeners.RequestResponseCreationStreamingListener;
...
public class RequestResponseStreamingTestCase {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(RequestResponseStreamingTestCase.class);
    ...
    public void setUp() {
        ...
        serverConnectorFuture.setHttpConnectorListener(new RequestResponseCreationStreamingListener());
        try {
