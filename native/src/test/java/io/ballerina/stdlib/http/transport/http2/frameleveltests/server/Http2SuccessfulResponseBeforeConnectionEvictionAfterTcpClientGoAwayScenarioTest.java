...
public class Http2SuccessfulResponseBeforeConnectionEvictionAfterTcpClientGoAwayScenarioTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Http2SuccessfulResponseBeforeConnectionEvictionAfterTcpClientGoAwayScenarioTest.class);
    ...
    @Test
    private void testSuccessfulConnectionBeforeConnectionEvictionAfterClientGoAway() throws IOException, InterruptedException {
