...
/**
 * This class test client 100-continue implementation with chunking request with fairly a large payload.
 * Contains both positive and negative test cases.
 */
public class ClientContinue100ChunkingTestCase {
    ...
    public void test100Continue() {
        try {
            ...
            TestUtil.handleException(
                    "Exception occurred while running test100Continue in ClientContinue100ChunkingTestCase", e);
        }
    }
    ...
    public void test100ContinueNegative() {
        try {
            ...
            TestUtil.handleException(
                    "Exception occurred while running test100ContinueNegative in ClientContinue100ChunkingTestCase", e);
        }
    }
    ...
    private void givenChunkingAlwaysClient() throws Exception {
    ...
    private DefaultHttpConnectorListener whenReqSentForPositiveResponse() throws IOException, InterruptedException {
        HttpCarbonMessage requestMsg = TestUtil
                .createHttpsPostReq(TestUtil.SERVER_CONNECTOR_PORT, TestUtil.largeEntity, "");
