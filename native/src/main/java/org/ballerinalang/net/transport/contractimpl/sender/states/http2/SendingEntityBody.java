...
package org.ballerinalang.net.transport.contractimpl.sender.states.http2;
...
import org.ballerinalang.net.transport.contractimpl.sender.http2.Http2TargetHandler.Http2RequestWriter;
...
import static org.ballerinalang.net.transport.contract.Constants.IDLE_TIMEOUT_TRIGGERED_WHILE_WRITING_OUTBOUND_REQUEST_BODY;
...
import static org.ballerinalang.net.transport.contractimpl.common.states.Http2StateUtil.onPushPromiseRead;
