...
import static io.ballerina.stdlib.http.transport.contract.Constants.ERROR_COULD_NOT_RESOLVE_HOST;
...
import static io.ballerina.stdlib.http.transport.contract.Constants.SSL_CONNECTION_ERROR;
