...
import static io.ballerina.stdlib.http.transport.contract.Constants.CLIENT_ENABLE_SESSION_CREATION;
import static io.ballerina.stdlib.http.transport.contract.Constants.CLIENT_SUPPORT_CIPHERS;
import static io.ballerina.stdlib.http.transport.contract.Constants.CLIENT_SUPPORT_SSL_PROTOCOLS;
import static io.ballerina.stdlib.http.transport.contract.Constants.HTTPS_SCHEME;
import static io.ballerina.stdlib.http.transport.contract.Constants.JKS;
...
import static io.ballerina.stdlib.http.transport.contract.Constants.SERVER_ENABLE_SESSION_CREATION;
import static io.ballerina.stdlib.http.transport.contract.Constants.SERVER_SUPPORTED_SERVER_NAMES;
...
public class SslConfiguration {
    ...
    public void setReferenceCountedOpenSslContext(ReferenceCountedOpenSslContext referenceCountedOpenSslContext) {
        sslConfig.setReferenceCountedOpenSslContext(referenceCountedOpenSslContext);
    }
