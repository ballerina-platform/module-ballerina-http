...
public class Http3QuicStreamInitializer extends ChannelInitializer<QuicStreamChannel> {
    ...
    public Http3QuicStreamInitializer(String interfaceId, ServerConnectorFuture serverConnectorFuture, Http3ServerChannelInitializer http3ServerChannelInitializer) {
    ...
    private void configureHttpPipeline(ChannelPipeline serverPipeline, long streamId, String interfaceId, ServerConnectorFuture serverConnectorFuture) {
