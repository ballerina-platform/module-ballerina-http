...
public class SendingEntityBody implements ListenerState{
    ...
    public SendingEntityBody(Http3OutboundRespListener http3OutboundRespListener, Http3MessageStateContext http3MessageStateContext, long streamId) {
...
//        this.conn = http3OutboundRespListener.getConnection();
    ...
    private void writeContent(Http3OutboundRespListener http3OutboundRespListener,
        ...
        if (httpContent instanceof LastHttpContent) {
            ...
            http3MessageStateContext
                    .setListenerState(new ResponseCompleted(http3OutboundRespListener, http3MessageStateContext,streamId));
        } else {
