...
import static io.ballerina.stdlib.http.transport.contractimpl.common.states.Http2StateUtil.releaseDataFrame;
import static io.ballerina.stdlib.http.transport.contractimpl.common.states.Http2StateUtil.sendRstFrame;
...
public class ResponseCompleted implements ListenerState {
    ...
    public void handleClientGoAway(ServerConnectorFuture serverConnectorFuture, ChannelHandlerContext
        ...
        LOG.warn("handleClientGoAway {}", ILLEGAL_STATE_ERROR);
    }
}
