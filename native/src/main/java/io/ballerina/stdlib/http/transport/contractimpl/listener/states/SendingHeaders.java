...
import static io.ballerina.stdlib.http.transport.contract.Constants.CHUNKING_CONFIG;
...
import static io.ballerina.stdlib.http.transport.contractimpl.common.Util.createHttpResponse;
...
import static io.ballerina.stdlib.http.transport.contractimpl.common.states.StateUtil.checkChunkingCompatibility;
import static io.ballerina.stdlib.http.transport.contractimpl.common.states.StateUtil.notifyIfHeaderWriteFailure;
...
public class SendingHeaders implements ListenerState {
    ...
    private void writeResponse(HttpCarbonMessage outboundResponseMsg, HttpContent httpContent, boolean headersWritten) {
        listenerReqRespStateManager.setState(new SendingEntityBody(outboundResponseListener,
                listenerReqRespStateManager, outboundRespStatusFuture, headersWritten));
