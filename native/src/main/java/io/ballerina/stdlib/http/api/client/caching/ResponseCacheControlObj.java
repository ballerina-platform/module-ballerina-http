...
import static io.ballerina.stdlib.http.api.HttpConstants.RES_CACHE_CONTROL_IS_PRIVATE_FIELD;
import static io.ballerina.stdlib.http.api.HttpConstants.RES_CACHE_CONTROL_MAX_AGE_FIELD;
import static io.ballerina.stdlib.http.api.HttpConstants.RES_CACHE_CONTROL_MUST_REVALIDATE_FIELD;
import static io.ballerina.stdlib.http.api.HttpConstants.RES_CACHE_CONTROL_NO_CACHE_FIELD;
import static io.ballerina.stdlib.http.api.HttpConstants.RES_CACHE_CONTROL_NO_CACHE_FIELDS_FIELD;
import static io.ballerina.stdlib.http.api.HttpConstants.RES_CACHE_CONTROL_NO_STORE_FIELD;
import static io.ballerina.stdlib.http.api.HttpConstants.RES_CACHE_CONTROL_NO_TRANSFORM_FIELD;
import static io.ballerina.stdlib.http.api.HttpConstants.RES_CACHE_CONTROL_PRIVATE_FIELDS_FIELD;
import static io.ballerina.stdlib.http.api.HttpConstants.RES_CACHE_CONTROL_PROXY_REVALIDATE_FIELD;
import static io.ballerina.stdlib.http.api.HttpConstants.RES_CACHE_CONTROL_S_MAXAGE_FIELD;
import static io.ballerina.stdlib.http.api.HttpUtil.FALSE;
import static io.ballerina.stdlib.http.api.HttpUtil.TRUE;
