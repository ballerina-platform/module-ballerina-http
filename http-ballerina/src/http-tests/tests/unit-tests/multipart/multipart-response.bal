...
service test2 on mockEP2 {
    ...
    resource function multipartOutResponse(http:Caller caller, http:Request request) {
        ...
        bodyPart2.setFileAsEntityBody("src/http_tests/tests/unit-tests/resources/datafiles/file.xml", mime:TEXT_XML);
        ...
        bodyPart4.setFileAsEntityBody("src/http_tests/tests/unit-tests/resources/datafiles/test.tmp");
