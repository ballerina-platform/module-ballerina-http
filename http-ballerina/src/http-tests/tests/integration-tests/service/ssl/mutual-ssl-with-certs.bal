...
http:ListenerConfiguration mutualSslCertServiceConf = {
    secureSocket: {
        keyFile: "src/http-tests/tests/integration-tests/certsAndKeys/private.key",
        certFile: "src/http-tests/tests/integration-tests/certsAndKeys/public.crt",
        trustedCertFile: "src/http-tests/tests/integration-tests/certsAndKeys/public.crt",
