...
function testTextBodyPartAsFileUpload() {
    ...
    filePart.setFileAsEntityBody("src/http_tests/tests/unit-tests/resources/datafiles/testFile.txt",
...
function testJsonBodyPartAsFileUpload() {
    ...
    jsonFilePart.setFileAsEntityBody("src/http_tests/tests/unit-tests/resources/datafiles/testJson.json",
...
function testXmlBodyPartAsFileUpload() {
    ...
    xmlFilePart.setFileAsEntityBody("src/http_tests/tests/unit-tests/resources/datafiles/file.xml",
...
function testBinaryBodyPartAsFileUpload() returns @tainted error? {
    io:ReadableByteChannel byteChannel = check io:openReadableFile
                                ("src/http_tests/tests/unit-tests/resources/datafiles/test.tmp");
