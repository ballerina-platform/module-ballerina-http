...
public type RequestMessage Request|string|xml|json|byte[]|io:ReadableByteChannel|();
...
public type ResponseMessage Response|string|xml|json|byte[]|io:ReadableByteChannel|();
