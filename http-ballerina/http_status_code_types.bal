...
public final StatusContinue STATUS_CONTINUE_OBJ = new;
public final StatusSwitchingProtocols STATUS_SWITCHING_PROTOCOLS_OBJ = new;
public final StatusOK STATUS_OK_OBJ = new;
public final StatusCreated STATUS_CREATED_OBJ = new;
public final StatusAccepted STATUS_ACCEPTED_OBJ = new;
public final StatusNonAuthoritativeInformation STATUS_NON_AUTHORITATIVE_INFORMATION_OBJ = new;
public final StatusNoContent STATUS_NO_CONTENT_OBJ = new;
public final StatusResetContent STATUS_RESET_CONTENT_OBJ = new;
public final StatusPartialContent STATUS_PARTIAL_CONTENT_OBJ = new;
public final StatusMultipleChoices STATUS_MULTIPLE_CHOICES_OBJ = new;
public final StatusMovedPermanently STATUS_MOVED_PERMANENTLY_OBJ = new;
public final StatusFound STATUS_FOUND_OBJ = new;
public final StatusSeeOther STATUS_SEE_OTHER_OBJ = new;
public final StatusNotModified STATUS_NOT_MODIFIED_OBJ = new;
public final StatusUseProxy STATUS_USE_PROXY_OBJ = new;
public final StatusTemporaryRedirect STATUS_TEMPORARY_REDIRECT_OBJ = new;
public final StatusPermanentRedirect STATUS_PERMANENT_REDIRECT_OBJ = new;
public final StatusBadRequest STATUS_BAD_REQUEST_OBJ = new;
public final StatusUnauthorized STATUS_UNAUTHORIZED_OBJ = new;
public final StatusPaymentRequired STATUS_PAYMENT_REQUIRED_OBJ = new;
public final StatusForbidden STATUS_FORBIDDEN_OBJ = new;
public final StatusNotFound STATUS_NOT_FOUND_OBJ = new;
public final StatusMethodNotAllowed STATUS_METHOD_NOT_ALLOWED_OBJ = new;
public final StatusNotAcceptable STATUS_NOT_ACCEPTABLE_OBJ = new;
public final StatusProxyAuthenticationRequired STATUS_PROXY_AUTHENTICATION_REQUIRED_OBJ = new;
public final StatusRequestTimeout STATUS_REQUEST_TIMEOUT_OBJ = new;
public final StatusConflict STATUS_CONFLICT_OBJ = new;
public final StatusGone STATUS_GONE_OBJ = new;
public final StatusLengthRequired STATUS_LENGTH_REQUIRED_OBJ = new;
public final StatusPreconditionFailed STATUS_PRECONDITION_FAILED_OBJ = new;
public final StatusPayloadTooLarge STATUS_PAYLOAD_TOO_LARGE_OBJ = new;
public final StatusUriTooLong STATUS_URI_TOO_LONG_OBJ = new;
public final StatusUnsupportedMediaType STATUS_UNSUPPORTED_MEDIA_TYPE_OBJ = new;
public final StatusRangeNotSatisfiable STATUS_RANGE_NOT_SATISFIABLE_OBJ = new;
public final StatusExpectationFailed STATUS_EXPECTATION_FAILED_OBJ = new;
public final StatusUpgradeRequired STATUS_UPGRADE_REQUIRED_OBJ = new;
public final StatusRequestHeaderFieldsTooLarge STATUS_REQUEST_HEADER_FIELDS_TOO_LARGE_OBJ = new;
public final StatusInternalServerError STATUS_INTERNAL_SERVER_ERROR_OBJ = new;
public final StatusNotImplemented STATUS_NOT_IMPLEMENTED_OBJ = new;
public final StatusBadGateway STATUS_BAD_GATEWAY_OBJ = new;
public final StatusServiceUnavailable STATUS_SERVICE_UNAVAILABLE_OBJ = new;
public final StatusGatewayTimeout STATUS_GATEWAY_TIMEOUT_OBJ = new;
public final StatusHttpVersionNotSupported STATUS_HTTP_VERSION_NOT_SUPPORTED_OBJ = new;
