...
listener http:Listener responseEp = new (responseTest, httpVersion = http:HTTP_1_1);
...
final http:Client responseClient = check new ("http://localhost:" + responseTest.toString(), httpVersion = http:HTTP_1_1);
