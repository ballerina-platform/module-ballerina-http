...
public const string APPLICATION_BINARY = "application/octet-stream";

public const string errorMessage = "Found an unexpected output:";

public const int HTTP2_PORT_RANGE = 10000;

public const string LARGE_ENTITY = "Lorem ipsum dolor sit amet, libris quaerendum sea ei, in nec fugit " +
