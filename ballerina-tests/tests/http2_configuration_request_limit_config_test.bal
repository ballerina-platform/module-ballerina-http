...
int http2RequestLimitsTestPort1 = getHttp2Port(requestLimitsTestPort1);
int http2RequestLimitsTestPort2 = getHttp2Port(requestLimitsTestPort2);
int http2RequestLimitsTestPort3 = getHttp2Port(requestLimitsTestPort3);
int http2RequestLimitsTestPort4 = getHttp2Port(requestLimitsTestPort4);
int http2RequestLimitsTestPort6 = getHttp2Port(requestLimitsTestPort6);
