...
int http2HateoasRuntimeErrorPort = getHttp2Port(hateoasRuntimeErrorPort);

listener http:Listener http2HateoasRuntimeErrorServerEP = check new(http2HateoasRuntimeErrorPort);
...
function testHttp2DuplicateResourceName() {
    ...
    error? err = http2HateoasRuntimeErrorServerEP.attach(duplicateResourceNameService, "service1");
    if err is error {
...
function testHttp2DuplicateLinkRelation() {
    ...
    error? err = http2HateoasRuntimeErrorServerEP.attach(duplicateResourceNameService, "service2");
    if err is error {
...
function testHttp2LinkedResourceNotFound() {
    ...
    error? err = http2HateoasRuntimeErrorServerEP.attach(duplicateResourceNameService, "service3");
    if err is error {
...
function testHttp2LinkedResourceNotFoundWithMethod() {
    ...
    error? err = http2HateoasRuntimeErrorServerEP.attach(duplicateResourceNameService, "service4");
    if err is error {
...
function testHttp2UnresolvedLinkedResource() {
    ...
    error? err = http2HateoasRuntimeErrorServerEP.attach(duplicateResourceNameService, "service5");
    if err is error {
