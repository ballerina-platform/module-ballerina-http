...
const int requestInterceptorNegativeTestPort = 9590;
const int requestInterceptorCallerRespondContinueTestPort = 9591;
const int requestInterceptorStringPayloadBindingTestPort = 9592;
const int requestInterceptorRecordPayloadBindingTestPort = 9593;
const int requestInterceptorRecordArrayPayloadBindingTestPort = 9594;
const int requestInterceptorByteArrayPayloadBindingTestPort = 9595;
const int requestInterceptorWithQueryParamTestPort = 9596;
const int requestInterceptorServiceConfigTestPort1 = 9597;
const int requestInterceptorServiceConfigTestPort2 = 9598;
const int clientFormUrlEncodedTestPort = 9599;
const int typedHeadersTestPort = 9600;
const int urlEncodedResponsesTestPort = 9601;
const int readonlyQueryTestPort = 9602;
const int responseInterceptorWithCallerRespondTestPort = 9603;
const int responseInterceptorCallerRespondContinueTestPort = 9604;
const int responseInterceptorWithoutCtxNextTestPort = 9605;
const int responseInterceptorSkipTestPort = 9606;
...
const int interceptorBasicTestsPort3 = 9612;
const int responseInterceptorReturnsErrorTestPort = 9613;
