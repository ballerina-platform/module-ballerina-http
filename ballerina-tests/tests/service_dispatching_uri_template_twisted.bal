...
listener http:Listener pathParamCheckListener = new(pathParamCheckTestPort, httpVersion = "1.1");
final http:Client pathParamTestClient = check new("http://localhost:" + pathParamCheckTestPort.toString(), httpVersion = "1.1");
