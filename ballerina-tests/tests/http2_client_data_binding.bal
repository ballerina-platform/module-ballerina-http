...
int http2ClientDatabindingTestPort1 = getHttp2Port(clientDatabindingTestPort1);
int http2ClientDatabindingTestPort2 = getHttp2Port(clientDatabindingTestPort2);
int http2ClientDatabindingTestPort3 = getHttp2Port(clientDatabindingTestPort3);
...
function testHttp25XXErrorPanic() returns error? {
    ...
    if response is http:Response {
        ...
        assertHeaderValue(check response.getHeader(CONTENT_TYPE), TEXT_PLAIN);
        assertHeaderValue(check response.getHeader("X-Type"), "test");
...
function testHttp2BinaryErrorSerialize() returns error? {
    ...
    if response is http:Response {
        ...
        assertHeaderValue(check response.getHeader(CONTENT_TYPE), mime:APPLICATION_OCTET_STREAM);
