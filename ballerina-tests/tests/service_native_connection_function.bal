...
listener http:Listener connectionNativeTestEP = new(connectionNativeTest, httpVersion = "1.1");
final http:Client connectionNativeClient = check new("http://localhost:" + connectionNativeTest.toString(), httpVersion = "1.1");
