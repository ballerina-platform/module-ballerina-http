...
const int serviceDetachTestPort = 9015;
const int serviceEndpointTestPort = 9016;

const int streamTestPort1 = 9021;
const int streamTestPort2 = 9022;

const int http2ListenerStopTest = 9708;
...
const int http2ContentLengthHeaderTestPort = 9650;
