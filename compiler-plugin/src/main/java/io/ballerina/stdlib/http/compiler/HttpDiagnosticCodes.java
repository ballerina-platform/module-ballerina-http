...
public enum HttpDiagnosticCodes {
    ...
    HTTP_146("HTTP_146", "resource name: '%s' conflicts with the path. Resource names can be reused only when the" +
            " resources have the same path", ERROR),
    HTTP_147("HTTP_147", "duplicate link relation: '%s'. Resource only supports unique relations" , ERROR),
    HTTP_148("HTTP_148", "cannot find resource with resource name: '%s'" , ERROR),
    HTTP_149("HTTP_149", "cannot resolve linked resource without method" , ERROR),
    HTTP_150("HTTP_150", "cannot find '%s' resource with resource name: '%s'" , ERROR),
